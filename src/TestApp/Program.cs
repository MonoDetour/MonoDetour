...
static class Program
{
    ...
    static void Main()
    {
        ...
        On.PlatformerController.SpinBounce.ILHook(m, static (ILContext il) =>
        {
            ...
            ILWeaver w = new(il);
            w.GotoMatch(GotoType.FirstPredicate,
                x => x.MatchLdarg(0),
                x => true,
                x => x.Match(OpCodes.Ldsfld)).Accept();
        });
...
class PlatformerControllerPatches
{
    ...
    internal static void MyPatch2(ref On.PlatformerController.SpinBounce.Params a)
    {
    ...
    [MonoDetour(DetourType.Prefix)]
    internal static void PrintBaz(in On.PlatformerController.SpinBounce.Params a)
    {
        Console.WriteLine("baz");
    }

    [MonoDetour(DetourType.Postfix)]
    internal static void PrintBar(in On.PlatformerController.SpinBounce.Params a)
    {
