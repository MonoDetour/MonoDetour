    ...
    public sealed class HookHelperGenerator : IIncrementalGenerator
    {
        ...
        )
        {
            foreach (var member in type.Members)
            {
                ...
                var hookType = il
                    ? "global::MonoMod.RuntimeDetour.ILHook"
                    : "global::MonoMod.RuntimeDetour.Hook";
                ...
                cb.WriteLine(
                        $"return new(method{(ctx.Bcl.DoesNotReturnAttribute ? "" : "!")}, hook, applyByDefault: applyByDefault);"
                    )
                    .CloseBlock()
                    .WriteLine();
                ;
